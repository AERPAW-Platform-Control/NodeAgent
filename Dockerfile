...
# make directories
RUN mkdir -p /nodeagent /var/local/aerpawNodeAgent/outbound

# copy NodeAgent files
COPY ./fetchContainer /nodeagent/fetchContainer
COPY ./startContainer /nodeagent/startContainer
COPY ./aerpawNodeAgent.py /nodeagent/aerpawNodeAgent.py
